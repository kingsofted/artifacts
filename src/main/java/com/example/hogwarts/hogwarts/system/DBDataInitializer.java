...
import com.example.hogwarts.hogwarts.wizard.WizardRepository;
...
public class DBDataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        a1.setImageUrl(
                "https://hogwartsartifactsonline.blob.core.windows.net/artifact-image-container/deluminator.jpg");
        ...
        a2.setImageUrl(
                "https://hogwartsartifactsonline.blob.core.windows.net/artifact-image-container/invisibility-cloak.jpg");
        ...
        a4.setImageUrl(
                "https://hogwartsartifactsonline.blob.core.windows.net/artifact-image-container/marauders-map.jpg");
        ...
        a5.setImageUrl(
                "https://hogwartsartifactsonline.blob.core.windows.net/artifact-image-container/sword-of-gryffindor.jpg");
        ...
        a6.setImageUrl(
                "https://hogwartsartifactsonline.blob.core.windows.net/artifact-image-container/resurrection-stone.jpg");
        ...
        // Cascade persist will add wizard along with artifacts
        if (!wizardRepository.existsByName("Albus Dumbledore")) {
            wizardRepository.save(w1);
        }
        if (!wizardRepository.existsByName("Harry Potter")) {
            wizardRepository.save(w2);
        }
        if (!wizardRepository.existsByName("Neville Longbottom")) {
            wizardRepository.save(w3);
        }        
        if (!artifactRepository.existsById(a6.getId())) {
